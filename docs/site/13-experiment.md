...
損失が当てずっぽうの \( \log 50 \approx 3.9 \) から下がっているのが分かります。
150 ステップ後の出力はこうです。
...
損失は 200 ステップで 2.0、600 ステップで 0.8 前後まで下がり、その後は 0.6〜1.5 の間を揺れます。
...
!!! tip "この章のまとめ"
    - 当てずっぽうの損失 \( \log 50 \approx 3.9 \) から、2000 ステップで 1 前後まで下がる
